...
void update(const Mat& curr, const Isometry3d& T_W_C, const double depth, PointCloud::Ptr point_cloud){
...
int main( int argc, char** argv ){
    ...
    string base_address = "/home/kevin/catkin_workspace/src/arm_scan_controller/scan_data/";
...
//    cout<<"the 66 picture distance is: " << to_string(depth.at(205)) << endl;
    ...
    for ( int index = 1; index<color_image_files.size(); index++ )
    {
        ...
        update(curr, pose_curr_TWC, curr_depth, pointCloud);
//        imshow("image", curr);
//        waitKey(1);
    }
